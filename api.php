...
if ($action === 'compose') {
    ...
    echo '<div id="composeAlert"></div>';
    
    echo '<form id="composeForm" onsubmit="sendEmail(event)">
        <div class="compose-form">
            <div class="form-group">
                <label for="to"><i class="fa-sharp-duotone fa-thin fa-user"></i> To</label>
                <input type="email" id="to" required value="' . htmlspecialchars($replyto) . '" placeholder="recipient@example.com">
            </div>
            <div class="form-group">
                <label for="subject"><i class="fa-sharp-duotone fa-thin fa-heading"></i> Subject</label>
                <input type="text" id="subject" required value="' . htmlspecialchars($subject) . '" placeholder="Email subject">
            </div>';
    ...
    if (!empty($signatures)) {
        ...
        foreach ($signatures as $sig) {
            echo '<option value="' . htmlspecialchars($sig['content']) . '">' . htmlspecialchars($sig['name']) . '</option>';
        }
        echo '</select></div>';
    }
    ...
    echo '<div id="progress" class="progress-overlay" style="display: none;">
