...
<body>
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                <div class="nav-section">
                    ...
                    <a href="?view=inbox" class="nav-link<?= $view == 'inbox' ? ' active' : '' ?>"
                        onclick="return window.app.navigateTo('inbox')">
                        <svg viewBox="0 0 24 24">
                    ...
                    <a href="?view=sent" class="nav-link<?= $view == 'sent' ? ' active' : '' ?>"
                        onclick="return window.app.navigateTo('sent')">
                        <svg viewBox="0 0 24 24">
                    ...
                    <a href="?view=drafts" class="nav-link<?= $view == 'drafts' ? ' active' : '' ?>"
                        onclick="return window.app.navigateTo('drafts')">
                        <svg viewBox="0 0 24 24">
                    ...
                    <a href="?view=starred" class="nav-link<?= $view == 'starred' ? ' active' : '' ?>"
                        onclick="return window.app.navigateTo('starred')">
                        <svg viewBox="0 0 24 24">
                            <polygon
                    ...
                    <a href="?view=trash" class="nav-link<?= $view == 'trash' ? ' active' : '' ?>"
                        onclick="return window.app.navigateTo('trash')">
                        <svg viewBox="0 0 24 24">
                ...
                <div class="nav-section">
                    ...
                    <a href="?view=settings" class="nav-link<?= $view == 'settings' ? ' active' : '' ?>"
                        onclick="return window.app.navigateTo('settings')">
                        <svg viewBox="0 0 24 24">
    ...
    <div class="mobile-bottom-nav" id="mobileBottomNav">
        <a href="?view=inbox" class="mob-nav-item<?= $view == 'inbox' ? ' active' : '' ?>"
            onclick="return window.app.navigateTo('inbox')">
            <svg viewBox="0 0 24 24">
                <polyline points="22 12 16 12 14 15 10 15 8 12 2 12" />
                <path
        ...
        <a href="?view=compose" class="mob-nav-item mob-compose<?= $view == 'compose' ? ' active' : '' ?>"
            onclick="return window.app.navigateTo('compose')">
            <svg viewBox="0 0 24 24"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
            <span class="mob-nav-label">Compose</span>
        </a>
        <a href="?view=sent" class="mob-nav-item<?= $view == 'sent' ? ' active' : '' ?>"
            onclick="return window.app.navigateTo('sent')">
            <svg viewBox="0 0 24 24">
                <line x1="22" y1="2" x2="11" y2="13" />
                <polygon points="22 2 15 22 11 13 2 9 22 2" />
        ...
        <div class="mob-nav-item mob-more" id="mobMoreBtn" onclick="window.app.toggleMobileMenu()">
            ...
            <div class="mob-more-dropdown" id="mobMoreDropdown">
                <a href="?view=drafts" class="mob-dropdown-item<?= $view == 'drafts' ? ' active' : '' ?>"
                    onclick="return window.app.navigateTo('drafts')">
                    <svg viewBox="0 0 24 24">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                        <polyline points="14 2 14 8 20 8" />
                ...
                <a href="?view=starred" class="mob-dropdown-item<?= $view == 'starred' ? ' active' : '' ?>"
                    onclick="return window.app.navigateTo('starred')">
                    <svg viewBox="0 0 24 24">
                        <polygon
                            points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                ...
                <a href="?view=trash" class="mob-dropdown-item<?= $view == 'trash' ? ' active' : '' ?>"
                    onclick="return window.app.navigateTo('trash')">
                    <svg viewBox="0 0 24 24">
                        <polyline points="3 6 5 6 21 6" />
                        <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" />
                ...
                <a href="?view=settings" class="mob-dropdown-item<?= $view == 'settings' ? ' active' : '' ?>"
                    onclick="return window.app.navigateTo('settings')">
                    <svg viewBox="0 0 24 24">
                        <circle cx="12" cy="12" r="3" />
                        <path
