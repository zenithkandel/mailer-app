...
<body>
    ...
    <div class="app-body">
        ...
        <aside class="sidebar">
            <div class="sidebar-nav">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="?view=starred" class="sidebar-item <?= $view=='starred'?'active':'' ?>" data-view="starred">
                ...
                <div class="sidebar-section">
                    ...
                    <a href="?view=compose" class="sidebar-item <?= $view=='compose'?'active':'' ?>" data-view="compose">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
                        <span class="nav-label">Compose</span>
                    </a>
                    <a href="?view=settings" class="sidebar-item <?= $view=='settings'?'active':'' ?>" data-view="settings">
        ...
        <main class="main-content" id="mainContent">
            <iframe id="contentFrame" class="content-frame" src="pages/<?= $view ?>.php" style="width:100%;height:100%;border:none;background:transparent;min-height:calc(100vh - var(--nav-h) - 56px);"></iframe>
        </main>
    </div>
